...
NAMEBOT = (tahadevstorm:get(DEVSTOR..'storm:name') or 'غامبول')
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦ تنبیه لا استطيع تفعيل المجموعه انا لست ادمن يرجى ترقيتي ادمن *\n🍃\n", 1, "md") 
return false  end 
...
storm_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ المجموعه تم تعگیلها بالتاكيد \nꪜ*', 1, 'md')
...
os.execute('wget https://raw.githubusercontent.com/javam0fbi/STORM/master/STORM.lua') 
os.execute('cd plugins_;wget https://raw.githubusercontent.com/javam0fbi/STORM/master/plugins_/help_rep.lua') 
sleep(0.5) 
...
monsend(msg,msg.chat_id_,'💥¦ اهلا عزيزي {'..get_rtba(msg)..'} 🍃\n📮¦ تـم قفل الروابط الان لايستطيعون ارسال الروابط \n✓',msg.sender_user_id_)  
...
monsend(msg,msg.chat_id_,'💥¦ اهلا عزيزي {'..get_rtba(msg)..'} 🍃\n📮¦ تـم فتح الروابط الان يستطيعون ارسال الروابط \n✓',msg.sender_user_id_)  
end
...
monsend(msg,msg.chat_id_,'💥¦ اهلا عزيزي {'..get_rtba(msg)..'} 🍃\n📮¦ تـم قفل الصور الان لايستطيعون ارسال الصور \n✓',msg.sender_user_id_)  
...
if text == '4564654.52' or text =='644564.5' or text=='يا 414545.5' then
local text = [[
📮¦ اهلا بك في سورس غامبول 🍃
ٴ━━━━━━━━━━
🗃¦ لتنصيب السورس ↓↑
ٴ━━━━━━━━━━
⚜¦ افتح ترمنال جديد 
